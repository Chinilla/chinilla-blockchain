...
from chinilla.wallet.nft_wallet.nft_puzzles import NFT_METADATA_UPDATER, NFT_STATE_LAYER_MOD_HASH
...
class NFTWallet:
    ...
    async def generate_new_nft(
        ...
        # TODO Set royalty address after NFT1 chinillalisp finished
        """
        This must be called under the wallet state manager lock
        """
        amount = uint64(1)
