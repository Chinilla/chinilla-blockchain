...
from chinilla.clvm.singleton import SINGLETON_TOP_LAYER_MOD
...
from chinilla.wallet.nft_wallet.nft_puzzles import LAUNCHER_PUZZLE, NFT_METADATA_UPDATER, NFT_STATE_LAYER_MOD_HASH
...
from chinilla.wallet.puzzles.puzzle_utils import make_create_coin_condition
...
class NFTWallet:
    ...
    async def coin_added(self, coin: Coin, height: uint32, in_transaction: bool) -> None:
        ...
        full_nodes: Dict[bytes32, WSChinillaConnection] = server.connection_by_type.get(NodeType.FULL_NODE, {})
    ...
    async def sign(self, spend_bundle: SpendBundle) -> SpendBundle:
        ...
        for spend in spend_bundle.coin_spends:
            try:
                ...
                # This only happens while you changed the NFT chinillalisp but didn't update the UncurriedNFT class.
                self.log.error(e)
            else:
