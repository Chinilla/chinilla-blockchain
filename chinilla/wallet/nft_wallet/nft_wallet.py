...
from chinilla.wallet.puzzles.singleton_top_layer_v1_1 import match_singleton_puzzle
...
class NFTWallet:
    ...
    async def generate_unsigned_spendbundle(
        ...
        unsigned_spend_bundle = SpendBundle.aggregate([nft_spend_bundle, chinilla_spend_bundle])

        return (unsigned_spend_bundle, chinilla_tx)
