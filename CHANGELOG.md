...
## 1.3.0 Beta Chinilla blockchain 2022-2-10
...
- Integrated the Bladebit plotter to CLI and GUI. Thanks @harold-b for all your hard work on this, and welcome again to the Chinilla team!
...
- In Windows the start menu item is now Chinilla and the icon in Add/Remove is updated.
...
- The Windows installer is now signed by a Chinilla certificate. It may take some time to develop enough reputation to not warn multiple times during install.
...
- We now codesign the Apple .dmg installer with the Chinilla developer ID on both GitHub Actions and Azure Pipelines. We will be notarizing and distributing the Azure Pipelines version as it's built on MacOS Mojave (10.14.6) for stronger cross version support.
