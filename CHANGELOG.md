...
- Added `chinilla wallet nft` command (see <https://docs.chinilla.net/docs/13cli/did_cli>)
- Added `chinilla wallet did` command (see <https://docs.chinilla.net/docs/12rpcs/nft_rpcs>)
- Added RPCs for DID (see <https://docs.chinilla.net/docs/12rpcs/did_rpcs>)
- Added RPCs for NFT (see <https://docs.chinilla.net/docs/12rpcs/nft_rpcs>)
...
- We now hand build Apple Silicon native binary wheels for all chinilla-blockchain dependencies and host them at [https://pypi.chinilla.net/simple](https://pypi.chinilla.net/simple). We are likely to hand build a MacOS ARM64 dmg available and certainly will for 1.0. You can install natively on M1 now with the `git clone` developer method today. Just make sure Python 3.9 is installed. `python3 --version` works.
...
- Chinilla wheels not on Pypi and some dependecies not found there also are now on pypi.chinilla.net.
...
- Testnet is now running at the primary port of 40444. Update your routers appropriately. This opens 8444 for mainnet.
