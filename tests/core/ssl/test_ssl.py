...
class TestSSL:
    ...
    async def test_farmer(self, farmer_one_harvester, self_hostname):
        ...
        chinilla_ca_crt_path, chinilla_ca_key_path = chinilla_ssl_ca_paths(bt.root_path, bt.config)
        ...
        generate_ca_signed_cert(chinilla_ca_crt_path.read_bytes(), chinilla_ca_key_path.read_bytes(), pub_crt, pub_key)
        ssl_context = ssl_context_for_client(chinilla_ca_crt_path, chinilla_ca_key_path, pub_crt, pub_key)
    ...
    async def test_full_node(self, wallet_node_sim_and_wallet, self_hostname):
        ...
        generate_ca_signed_cert(
            chinilla_ca_crt_path.read_bytes(),
            chinilla_ca_key_path.read_bytes(),
            pub_crt,
            pub_key,
        )
        ssl_context = ssl_context_for_client(chinilla_ca_crt_path, chinilla_ca_key_path, pub_crt, pub_key)
