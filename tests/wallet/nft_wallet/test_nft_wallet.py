...
async def test_nft_wallet_rpc_update_metadata(two_wallet_nodes: Any, trusted: Any) -> None:
    ...
    tr1 = await api_0.nft_add_uri(
        {
            ...
            "hash": "0xD4584AD463139FA8C0D9F68F4B59F185",
            "uri": "https://www.chinilla.com/img/branding/chinilla-logo-white.svg",
        }
    )
    ...
    while time_left > 0:
        ...
        try:
            ...
            uris = coin["data_uris"]
            assert len(uris) == 2
            assert "https://www.chinilla.com/img/branding/chinilla-logo-white.svg" in uris
        except AssertionError:
            if time_left < 0:
                raise
        await asyncio.sleep(0.5)
    ...
    tr1 = await api_0.nft_add_uri(
        {
            ...
            "nft_coin_id": nft_coin_id,
            "hash": "0xD4584AD463139FA8C0D9F68F4B59F185",
            "uri": "https://www.chinilla.com/img/branding/chinilla-logo-more-white.svg",
        }
    )
    ...
    while time_left > 0:
        ...
        try:
            ...
            uris = coin["data_uris"]
            assert len(uris) == 3
            assert "https://www.chinilla.com/img/branding/chinilla-logo-more-white.svg" in uris
        except AssertionError:
            if time_left < 0:
                raise
        await asyncio.sleep(0.5)
