...
def test_update_metadata() -> None:
    ...
    metadata = [
        ("u", ["https://download.chinilla.com/img/branding/chinilla-logo.svg"]),
        ("h", 0xD4584AD463139FA8C0D9F68F4B59F185),
        ("mu", []),
        ("mh", 0xD4584AD463139FA8C0D9F68F4B59F185),
        ("lu", ["https://download.chinilla.com/img/branding/chiinlla-logo.svg"]),
    ...
    metadata = [
        ...
        ("mu", ["https://url2"]),
        ("mh", 0xD4584AD463139FA8C0D9F68F4B59F185),
        ("lu", ["https://www.chinilla.com/img/branding/chinilla-logo.svg"]),
        ("lh", 0xD4584AD463139FA8C0D9F68F4B59F185),
    ]
    cost, res = NFT_STATE_LAYER_MOD.run_with_cost(INFINITE_COST, solution)
