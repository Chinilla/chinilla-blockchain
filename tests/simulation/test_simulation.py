...
from chinilla.simulator.setup_nodes import SimulatorsAndWallets, setup_full_system, setup_simulators_and_wallets
...
class TestSimulation:
    ...
    @pytest.mark.parametrize(
        argnames="amounts",
        argvalues=[
            *[pytest.param([uint64(1)] * n, id=f"1 vojo x {n}") for n in [0, 1, 10, 49, 51, 103]],
            *[
