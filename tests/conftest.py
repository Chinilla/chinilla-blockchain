...
from chinilla.util.task_timing import main as task_instrumentation_main
...
from chinilla.simulator.block_tools import BlockTools, create_block_tools, create_block_tools_async, test_constants
...
async def simulator_and_wallet() -> AsyncIterator[
    Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, ChinillaServer]], BlockTools]
]:
